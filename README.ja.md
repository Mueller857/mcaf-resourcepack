...
| `en_ud` | 上下逆さま英語 | ɥsᴉꞁᵷuƎ (uʍoᗡ ǝpᴉsd∩) | <img src="badges/en_ud.png"> | 96% | 96% |
| `enp` | アングリッシュ | Anglish (Oned Riches) | <img src="badges/enp.png"> | 53% | 53% |
...
| `he_il` | ヘブライ語 | עברית (ישראל) | <img src="badges/he_il.png"> | 19% | 6% |
| `it_it` | イタリア語 | Italiano (Italia) | <img src="badges/it_it.png"> | 0% | 0% |
| `ja_jp` | 日本語 | 日本語 (日本) | <img src="badges/ja_jp.png"> | 99% | 29% |
| `ko_kr` | 韓国語 | 한국어 (대한민국)| <img src="badges/ko_kr.png"> | 82% | 4% |
| `lzh` | 漢文 | 文言 (華夏)| <img src="badges/lzh.png"> | 99% | 51% |
...
| `ru_ru` | ロシア語 | Русский (Россия) | <img src="badges/ru_ru.png"> | 11% | 0% |
| `th_th` | タイ語 | ไทย (ประเทศไทย) | <img src="badges/th_th.png"> | 0% | 0% |
| `uk_ua` | ウクライナ語 | Українська (Україна) | <img src="badges/uk_ua.png"> | 0% | 0% |
| `zh_cn` | 簡体字中国語 | 简体中文 (中国大陆) | <img src="badges/zh_cn.png"> | 100% | 93% |
| `zh_hk` | 繁体字中国語（香港） | 繁體中文 (香港特別行政區) | <img src="badges/zh_hk.png"> | 73% | 73% |
| `zh_tw` | 繁体字中国語（台湾） | 繁體中文 (台灣) | <img src="badges/zh_tw.png"> | 65% | 1% |
